...
public class UserDAO extends BaseDAO {
	 ...
	 * the database
	 * 
	 * @param userJSON - User can pass a JSON string representing User row. You can pass partial JSON 
	 * string ie. not setting all the fields present in the user table.
	 * @return UserTO - Returns UsertTO with everything that was being passed plus system created 
	 * values like userId, createdOn dates etc.
